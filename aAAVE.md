---
title: Community Greenlight Poll - aAAVE (aAAVE) - March 15, 2021
summary: Signal your support or opposition to prioritising onboarding aAAVE (aAAVE). 
...
options:
   ...
   2: No (Defer)
---
# Poll: Community Greenlight Poll - aAAVE (aAAVE) - March 15, 2021
...
This poll asks whether the asset aAAVE (aAAVE) should be prioritized for inclusion in the Maker Protocol by the [domain teams](https://github.com/makerdao/mips/blob/master/MIP7/mip7.md#mip7c2-the-current-domain-roles-list). 
...
* The 'greenlight score' will be calculated for aAAVE (aAAVE) using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for aAAVE (aAAVE) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitator(s).
